...
static constexpr float BRICK_SHAKE_INTERVAL = 35.0f;   
static constexpr float BRICK_SHAKE_DURATION = 0.10f;  
static constexpr float BRICK_SHAKE_AMPLITUDE = 4.0f;
...
{
    float t = glfwGetTime();                 
    float phase = fmod(t, BRICK_SHAKE_INTERVAL);  
    bool  brickShake = phase < BRICK_SHAKE_DURATION;
